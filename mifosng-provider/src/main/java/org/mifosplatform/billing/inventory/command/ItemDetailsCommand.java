...
public class ItemDetailsCommand {
	...
	public ItemDetailsCommand(Long itemMasterId,String serialNumber,Long grnId,String provisiningSerialNumber,String quality,String status, Long officeId,Long clientId,Long warranty, String remark,Set<String> modifiedParameters){
	...
	public ItemDetailsCommand(Long itemMasterId,String serialNumber,Long grnId,String provisiningSerialNumber,String quality,String status, Long officeId,Long clientId,Long warranty, String remark){
		this.itemMasterId=itemMasterId;
		this.serialNumber=serialNumber;
		this.grnId=grnId;
		this.provisioningSerialNumber=provisiningSerialNumber;
